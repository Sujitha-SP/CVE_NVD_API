"""
THIS FILE IS USED FOR UPDATING THE VALUES INVOLVED IN THE DATABASE. ffrom the offest 0 with 2000 records till all the chunks 
"""
...
def load_data_mysql(data):
    try:
        ...
        #data needed for the project stored in SECURIN DATABASE 
